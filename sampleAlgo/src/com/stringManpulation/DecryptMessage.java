...
The internet is a common way for many terrorists, organized crime to communicate. However, since messages may be intercepted by law enforcement agencies, some of them develop means of encryption to deliver their messages safely. One of the modern challenges is decrypting the communication.
...
public class DecryptMessage {
	...
	public static void main(String[] args) {
		...
		int secondStep = 1;
		String str="flgxswdliefy";
		StringBuffer sb = new StringBuffer(str);
		
		for(int i=0;i<sb.length();i++){
			int temp = (int)sb.charAt(i);
			temp = temp - secondStep;
		...
		System.out.println("Original String : " + str + " === > Decrypt String : " + sb.toString());
